...
$.extend( $.validator, {
	...
	messages: {
		...
		digits: "Для ввода доступны только цифры.",
		equalTo: "Введите снова то же значение.",
		maxlength: $.validator.format( "Введите более чем {0} символов." ),
		minlength: $.validator.format( "Введите не менее {0} символов." ),
		rangelength: $.validator.format( "Введите значение длиной между {0} и {1} символов." ),
		...
		step: $.validator.format( "Введите значение делимое на {0}." )
	},
